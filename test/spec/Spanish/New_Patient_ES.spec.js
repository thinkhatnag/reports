...
it("Automatic Sync Verification (Offline to Online and Vice Versa) for the First Encounte -Es", async () => {
  await driver.pause(2000);
...
it("App Killed in Offline and Reopened in Online Mode Verification for the First Encounte -Es", async () => {
